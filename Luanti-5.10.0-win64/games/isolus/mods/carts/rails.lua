...
carts:register_rail("carts:copper_rail", {
	description = S("Copper Rail"),
	tiles = {
		"carts_rail_copper.png", "carts_rail_copper_curved.png",
		"carts_rail_copper_t_junction.png", "carts_rail_copper_crossing.png"
	},
	groups = carts:get_rail_groups(),
}, {})

core.register_craft({
	output = "carts:copper_rail 18",
	recipe = {
