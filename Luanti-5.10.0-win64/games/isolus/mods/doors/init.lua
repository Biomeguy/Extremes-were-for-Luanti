...
core.register_node("doors:hidden", {
	...
	collision_box = {
		type = "fixed",
		fixed = {-15/32, 13/32, -15/32, -13/32, .5, -13/32}
	},
})
...
local function on_place_node(place_to, newnode,
	placer, oldnode, itemstack, pointd)
	-- Run script hook
	for _, callback in ipairs(core.registered_on_placenodes) do
		...
		local pointd_copy = {
			type = pointd.type,
			above = vector.new(pointd.above),
			under = vector.new(pointd.under),
			ref = pointd.ref,
		}
		callback(place_to_copy, newnode_copy, placer,
			oldnode_copy, itemstack, pointd_copy)
	end
end
	...
	core.register_craftitem(":" .. name, {
		...
		on_place = function(itemstack, placer, pointd)
			...
			if pdef and pdef.on_rightclick and
				...
				return pdef.on_rightclick(pointd.under,
						node, placer, itemstack, pointd)
			end
...
doors.register("door_coco_palm_wood", {
	tiles = {{ name = "doors_door_coco_palm_wood.png", backface_culling = true}},
	description = S("Coco Palm Wood Door"),
	inventory_image = "doors_item_coco_palm_wood.png",
	groups = {node = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
	gain_open = .06,
	gain_close = .13,
	recipe = {
		{"default:coco_palm_wood", "default:coco_palm_wood"},
		{"default:coco_palm_leaves", "default:coco_palm_leaves"},
		{"default:coco_palm_wood", "default:coco_palm_wood"}
	}
})
...
doors.register("door_wood_2", {
	...
	description = S("Dark Wooden Door"),
	inventory_image = "doors_item_wood_2.png",
	groups = {node = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
	gain_open = .06,
	gain_close = .13,
	recipe = {
		{"default:jungle_wood", "default:jungle_wood"},
		{"default:jungle_wood", "default:jungle_wood"},
		{"default:jungle_wood", "default:jungle_wood"}
	}
})
...
doors.register("door_obsidian_glass", {
	...
	groups = {node = 1, cracky=3, oddly_breakable_by_hand=1},
	sounds = default.node_sound_glass_defaults(),
	sound_open = "doors_glass_door_open",
	sound_close = "doors_glass_door_close",
	gain_open = .3,
...
function doors.register_trapdoor(name, def)
	...
	if def.protected then
		def.can_dig = can_dig_door
		def.after_place_node = function(pos, placer, itemstack, pointd)
...
function doors.register_fencegate(name, def)
	local fence = {
		...
		on_rightclick = function(pos, node, clicker, itemstack, pointd)
			...
			core.sound_play(node_def._gate_sound, {pos = pos, gain = .15,
...
doors.register_fencegate("doors:gate_coco_palm_wood", {
	description = S("Coco Palm Wood Fence Gate"),
	texture = "default_coco_palm_wood.png",
...
doors.register_fencegate("doors:gate_mangrove_wood", {
	description = S("Mangrove Wood Fence Gate"),
	texture = "default_mangrove_wood.png",
...
core.register_craft({
	type = "fuel",
	recipe = "doors:gate_apple_wood_closed",
	burntime = 7,
})
...
core.register_craft({
	type = "fuel",
	recipe = "doors:gate_coco_palm_wood_closed",
	burntime = 6,
})
...
core.register_craft({
	type = "fuel",
	recipe = "doors:gate_mangrove_wood_closed",
	burntime = 7,
})
