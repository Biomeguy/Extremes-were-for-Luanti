...
armor = {
	...
	attributes = {"heal", "fire", "water", "feather", "head_lamp"},
	...
	materials = {
		wood = "group:wood",
		cactus = "group:large_cactus",
		gold = "default:gold_ingot",
		copper = "default:copper_ingot",
		silver = "default:silver_ingot",
		brass = "default:brass_ingot",
		bronze = "default:bronze_ingot",
		wrought_iron = "default:wrought_iron_ingot",
		cast_iron = "default:cast_iron_ingot",
		chainmail = "xpanes:bar_flat",
		steel = "default:steel_ingot",
		stainless_steel = "default:stainless_steel_ingot",
		mese = "default:mese_crystal",
		ocealite = "default:ocealite_crystal",
		diamond = "default:diamond",
		mithril = "default:mithril_ingot",
		crystal = "default:crystal_ingot",
		nether = "nether:nether_ingot",
		steeldian = "steeldian:ingot",
	},
	fire_nodes = {
		...
		{"fire:firemite_flame",		4, 5},
		{"fire:watermite_flame",	4, 5},
		{"fire:campfire_active",		3, 4},
		{"fire:campfire_active_with_grille",	3, 4},
		{"burning_bush:leaves",		3, 4},
		{"nssm:mornen",				4, 2},
		{"nssm:mornen_flowing",		4, 2},
		{"nssm:mornar",				4, 4},
		{"nssm:phoenix_fire",		4, 4},
		{"ethereal:fire_flower",	2, 2},
		{"mapgen:geyser_steam",		3, 2},
		{"default:crystal_spike",	2, 1},
		{"nether:lava_crust",		2, 1},
		{"default:torch",			1, 1},
		{"default:torch_ceiling",	1, 1},
		{"default:torch_wall",		1, 1},
		{"gloop:kalite_torch",			1, 1},
		{"gloop:kalite_torch_ceiling",	1, 1},
		{"gloop:kalite_torch_wall",		1, 1},
		{"xtraores:antracite_torch",			2, 2},-- Don't know why these don't work
		{"xtraores:antracite_torch_ceiling",	2, 2},
		{"xtraores:antracite_torch_wall",		2, 2},
	},
...
armor.register_armor = function(self, name, def)
	...
	def.on_place = function(itemstack, player, pointd)
		if pointd.type == "node" and player and not player:get_player_control().sneak then
			local node = core.get_node(pointd.under)
			local ndef = core.registered_nodes[node.name]
			if ndef and ndef.on_rightclick then
				return ndef.on_rightclick(pointd.under, node, player, itemstack, pointd)
			end
		end
		return armor:equip(player, itemstack)
	end
