...
armor:register_armor(":3d_armor:helmet_admin", {
	...
	groups = {armor_head=1, armor_heal=100, armor_use=0, armor_water=1, not_in_creative_inventory=1},
...
armor:register_armor(":3d_armor:leggings_admin", {
	...
	armor_groups = {fleshy=100},
	groups = {armor_legs=1, armor_heal=100, armor_use=0, not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
...
armor:register_armor(":3d_armor:boots_admin", {
	...
	armor_groups = {fleshy=100},
	groups = {armor_feet=1, armor_heal=100, armor_use=0, not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
