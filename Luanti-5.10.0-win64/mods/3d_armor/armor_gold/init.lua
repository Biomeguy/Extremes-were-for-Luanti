...
if core.get_modpath("illumination") then
	armor:register_armor(":3d_armor:headlamp_gold", {
		description = S("Gold Head Lamp"),
		inventory_image = "3d_armor_inv_headlamp_gold.png",
		groups = {armor_head=1, armor_heal=3, armor_use=150, armor_head_lamp=1},
		armor_groups = {fleshy=2},
		damage_groups = {cracky=3, snappy=3, choppy=3, crumbly=3, level=1},
	})
	core.register_craft({
		output = "3d_armor:headlamp_".. s,
		recipe = {
			{m, "stairs:slab_meselamp", m},
			{m, "", m}
		}
	})
end
