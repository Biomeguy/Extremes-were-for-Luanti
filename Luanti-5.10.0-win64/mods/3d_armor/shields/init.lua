...
core.register_alias("adminshield", "shields:shield_admin")
...
if armor.materials.silver then
	armor:register_armor("shields:shield_silver", {
		description = S("Silver Shield"),
		inventory_image = "shields_inv_shield_silver.png",
		groups = {armor_shield=1, armor_heal=6, armor_use=270, radiation=53,
...
if armor.materials.brass then
	armor:register_armor("shields:shield_brass", {
		description = S("Brass Shield"),
		inventory_image = "shields_inv_shield_brass.png",
		groups = {armor_shield=1, armor_heal=6, armor_use=400, radiation=43,
			physics_speed=-0.03, physics_gravity=0.03},
		armor_groups = {fleshy=10},
...
if armor.materials.copper then
	armor:register_armor("shields:shield_copper", {
		...
		inventory_image = "shields_inv_shield_copper.png",
		groups = {armor_shield=1, armor_heal=0, armor_use=750,
...
if armor.materials.wrought_iron then
	armor:register_armor("shields:shield_wrought_iron", {
		description = S("Wrought Iron Shield"),
		inventory_image = "shields_inv_shield_wrought_iron.png",
...
if armor.materials.cast_iron then
	armor:register_armor("shields:shield_cast_iron", {
		description = S("Cast Iron Shield"),
		inventory_image = "shields_inv_shield_cast_iron.png",
		groups = {armor_shield=1, armor_heal=0, armor_use=800, radiation=40,
			physics_speed=-0.05, physics_gravity=0.05},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=2, snappy=3, choppy=2, crumbly=1, level=2},
		reciprocate_damage = true,
...
if armor.materials.chainmail then
	armor:register_armor("shields:shield_chainmail", {
		description = S("Chainmail Shield"),
		inventory_image = "shields_inv_shield_chainmail.png",
		groups = {armor_shield=1, armor_heal=0, armor_use=750,
			physics_speed=-0.04, physics_gravity=0.04},
		armor_groups = {fleshy=8},
		damage_groups = {cracky=2, snappy=3, choppy=2, crumbly=1, level=2},
...
if armor.materials.stainless_steel then
	armor:register_armor("shields:shield_stainless_steel", {
		description = S("Stainless Steel Shield"),
		inventory_image = "shields_inv_shield_stainless_steel.png",
		groups = {armor_shield=1, armor_heal=5, armor_use=700, radiation=40,
...
if armor.materials.mese then
	armor:register_armor("shields:shield_mese", {
		description = S("Mese Shield"),
		inventory_image = "shields_inv_shield_mese.png",
		groups = {armor_shield=1, armor_heal=9, armor_use=150, physics_jump=.1,
			physics_speed=.1},
		armor_groups = {fleshy=13.4},
...
if armor.materials.ocealite then
	armor:register_armor("shields:shield_ocealite", {
		description = S("Ocealite Shield"),
		inventory_image = "shields_inv_shield_ocealite.png",
		groups = {armor_shield=1, armor_heal=9, armor_use=150, physics_jump=.1,
...
if armor.materials.crystal then
	...
	armor:register_armor("shields:shield_crystal", {
		description = S("Frost Crystal Shield"),
...
if armor.materials.steeldian then
	armor:register_armor("shields:shield_steeldian", {
		description = S("Steeldian Shield"),
		inventory_image = "shields_inv_shield_steeldian.png",
