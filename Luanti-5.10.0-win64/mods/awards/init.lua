...
awards.gettext, awards.ngettext = dofile(core.get_modpath("awards").."/src/intllib.lua")

-- Load files
dofile(core.get_modpath("awards").."/src/data.lua")
dofile(core.get_modpath("awards").."/src/api_awards.lua")
dofile(core.get_modpath("awards").."/src/api_triggers.lua")
dofile(core.get_modpath("awards").."/src/chat_commands.lua")
dofile(core.get_modpath("awards").."/src/gui.lua")
dofile(core.get_modpath("awards").."/src/triggers.lua")
dofile(core.get_modpath("awards").."/src/awards.lua")
