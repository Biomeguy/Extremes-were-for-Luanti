...
if core.get_modpath("default") then
	...
	awards.register_award("awards_stone_brick", {
		title = S("Outpost"),
	...
	awards.register_award("awards_stone_brick2", {
		title = S("Watchtower"),
	...
	awards.register_award("awards_stone_brick3", {
		title = S("Fortress"),
	...
	awards.register_award("awards_desert_stone_brick", {
		...
		trigger = {
			type = "craft",
			item = "default:desert_stone_brick",
			target = 400
		}
	})

	awards.register_award("awards_desertstone_brick", {
		title = S("Pharaoh"),
	...
	awards.register_award("award_lumberjack_firstday", {
		...
		icon = "default_beech_trunk.png^awards_level1.png",
		difficulty = 0.03,
		trigger = {
			type = "dig",
			node = "default:beech_trunk",
			target = 6
		}
	})
	...
	awards.register_award("award_lumberjack", {
		...
		icon = "default_beech_trunk.png^awards_level2.png",
		difficulty = 0.03,
		trigger = {
			type = "dig",
			node = "default:beech_trunk",
	...
	awards.register_award("award_lumberjack_semipro", {
		...
		icon = "default_beech_trunk.png^awards_level3.png",
		difficulty = 0.03,
		trigger = {
			type = "dig",
			node = "default:beech_trunk",
	...
	awards.register_award("award_lumberjack_professional", {
		...
		icon = "default_beech_trunk.png^awards_level4.png",
		difficulty = 0.03,
		trigger = {
			type = "dig",
			node = "default:beech_trunk",
	...
	awards.register_award("award_junglebaby", {
		...
		icon = "default_jungle_trunk.png^awards_level1.png",
		difficulty = 0.05,
		trigger = {
			type = "dig",
			node = "default:jungle_trunk",
			target = 100
		}
	})
	...
	awards.register_award("award_jungleman", {
		...
		icon = "default_jungle_trunk.png^awards_level2.png",
		difficulty = 0.05,
		trigger = {
			type = "dig",
			node = "default:jungle_trunk",
	...
	awards.register_award("awards_jungle_grass", {
		title = S("Jungle Discoverer"),
		description = S("Mine your first jungle grass."),
		icon = "default_jungle_grass.png",
		difficulty = 0.009,
		trigger = {
			type = "dig",
			node = "default:jungle_grass",
			target = 1
		}
	})
	...
	awards.register_award("awards_snow_block", {
	...
	awards.register_award("awards_diamond_block", {
	...
	awards.register_award("award_obsidian_brick", {
...
if core.get_modpath("farming") then
	awards.register_award("awards_farmer", {
		...
		icon = "farming_wheat_S8.png^awards_level1.png",
		trigger = {
			type = "dig",
			node = "farming:wheat_S8",
			target = 1
		}
	})
	awards.register_award("awards_farmer2", {
		...
		icon = "farming_wheat_S8.png^awards_level2.png",
		trigger = {
			type = "dig",
			node = "farming:wheat_S8",
			target = 25
	...
	awards.register_award("awards_farmer3", {
		...
		icon = "farming_wheat_S8.png^awards_level3.png",
		trigger = {
			type = "dig",
			node = "farming:wheat_S8",
			target = 125
	...
	awards.register_award("awards_farmer4", {
		...
		icon = "farming_wheat_S8.png^awards_level4.png",
		trigger = {
			type = "dig",
			node = "farming:wheat_S8",
			target = 625
	...
	awards.register_award("award_bread", {
		title = S("Baker"),
		description = S("Eat 10 loaves of wheat bread."),
		icon = "farming_wheat_bread.png",
		trigger = {
			type = "eat",
			item = "farming:wheat_bread",
			target = 10
		}
	})
...
if core.get_modpath("fabric") and core.get_modpath("farming") then
	awards.register_award("awards_fabric", {
		title = S("Wool Over Your Eyes"),
		description = S("Craft 250 white fabric block."),
		icon = "fabric_block_white.png",
		trigger = {
			type = "craft",
			item = "fabric:block_white",
			target = 250
		}
	})
end
...
if core.get_modpath("stairs") then
	awards.register_award("award_stairs_gold_block", {
		title = S("Filthy Rich"),
		description = S("Craft 24 gold block stairs."),
		icon = "default_gold_block.png",
		trigger = {
			type = "craft",
			item= "stairs:stair_gold_block",
			target = 24
		}
	})
end
