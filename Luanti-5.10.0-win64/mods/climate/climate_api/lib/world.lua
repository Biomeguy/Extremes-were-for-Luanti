...
local function update_wind(timer)
	nobj_wind_x = nobj_wind_x or core.get_perlin(pn_wind_speed_x)
	nobj_wind_z = nobj_wind_z or core.get_perlin(pn_wind_speed_z)
...
local function update_heat(timer)
	nobj_heat = nobj_heat or core.get_perlin(pn_heat)
...
local function update_humidity(timer)
	nobj_humidity = nobj_humidity or core.get_perlin(pn_humidity)
