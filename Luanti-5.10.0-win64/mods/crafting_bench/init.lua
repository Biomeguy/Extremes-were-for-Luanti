...
local crafting_rate = core.settings:get("crafting_bench_crafting_rate")
if crafting_rate == nil then crafting_rate = 5 end


core.register_node("crafting_bench:workbench",{
	...
	tiles = {"crafting_bench_workbench_top.png", "crafting_bench_workbench_bottom.png", "crafting_bench_workbench_side.png",
		"crafting_bench_workbench_side.png", "crafting_bench_workbench_back.png", "crafting_bench_workbench_front.png"},
	paramtype2 = "facedir",
	paramtype = "light",
	...
	on_metadata_inventory_move = function(pos, from_list, from_index, to_list, to_index, count, player)
		core.log("action", S("@1 moves stuff in workbench at @2", player:get_player_name(), core.pos_to_string(pos)))
	end,
	on_metadata_inventory_put = function(pos, listname, index, stack, player)
		core.log("action", S("@1 moves stuff to workbench at @2", player:get_player_name(), core.pos_to_string(pos)))
	end,
	on_metadata_inventory_take = function(pos, listname, index, stack, player)
		core.log("action", S("@1 takes stuff from workbench at @2", player:get_player_name(), core.pos_to_string(pos)))
	end,
})
...
core.register_craft({
	...
	recipe = {
		...
		{"default:beech_trunk", "default:beech_trunk","default:steel_ingot"}
	}
})
