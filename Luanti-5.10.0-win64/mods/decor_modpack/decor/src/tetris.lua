...
local buttons = "button[3,4.5;0.6,0.6;left;<]"
	.."button[3.6,4.5;0.6,0.6;rotateleft;"..core.formspec_escape(S("L")).."]"
	.."button[4.2,4.5;0.6,0.6;down;v]"
	.."button[4.2,5.3;0.6,0.6;drop;V]"
	.."button[4.8,4.5;0.6,0.6;rotateright;"..core.formspec_escape(S("R")).."]"
	.."button[5.4,4.5;0.6,0.6;right;>]"
	.."button[3.5,3;2,2;new;"..core.formspec_escape(S("New Game")).."]"
...
local function step(pos, fields)
	...
	local t = core.deserialize(meta:get_string("tetris"))
	...
	local scr = { formsize, background,
		...
		meta:set_string("tetris", core.serialize(t))
	end
...
core.register_node("decor:tetris_arcade", {
	...
	on_construct = function(pos)
		...
		meta:set_string("formspec", formsize
			.."button[2,2.5;2,2;new;"..core.formspec_escape(S("New Game")).."]"
			..default.gui_bg..default.gui_bg_img..default.gui_slots)
	end,
	...
	on_place = function(itemstack, placer, pointd)
		...
		if core.is_protected(pos, placer:get_player_name()) or
			core.is_protected({x=pos.x, y=pos.y+1, z=pos.z}, placer:get_player_name()) then
			return itemstack
		end
		if core.get_node({x=pos.x, y=pos.y+1, z=pos.z}).name ~= "air" then
			core.chat_send_player(placer:get_player_name(), S("No room for the Arcade!"))
			return itemstack
		end
		local dir = placer:get_look_dir()
		local node = {name="decor:tetris_arcade", param1=0, param2 = core.dir_to_facedir(dir)}
