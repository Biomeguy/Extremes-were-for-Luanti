...
core.register_craft({
	output ="inbox:empty",
	recipe = {
		{"dye:white","default:steel_ingot","dye:red"},
...
core.register_node("inbox:empty", {
	paramtype = "light",
	drawtype = "mesh",
	mesh = "inbox_mailbox.obj",
	description = S("Mailbox"),
	tiles = {"inbox_red_metal.png", "inbox_white_metal.png", "inbox_grey_metal.png"},
	...
	on_rightclick = function(pos, node, clicker, itemstack)
		...
		if owner == pname or
				core.check_player_privs(pname, "protection_bypass") and
