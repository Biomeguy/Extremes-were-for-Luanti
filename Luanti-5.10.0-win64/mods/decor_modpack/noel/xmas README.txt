...
xmas, this is a mod for luanti/freeminer/minetime that grows a decorated 24 node (72m) 
tree, it is perfect for that holiday theme!

Balls are set to mesh but as a fallback they will be shown as fabric nodes only if
your version isn't compatible with mesh nodes!

to remove tree just dig the trunk, all balls and leaves are set up for leafdecay.
