...
function xdecor.register(name, def)
	...
	core.register_node("xdecor:" .. name, def)

	local workbench = core.settings:get_bool("enable_xdecor_workbench")

	if workbench == false and
	  (core.get_modpath("moreblocks") or core.get_modpath("stairs")) then
...
function xdecor.register_legacy_aliases(original_basename, new_basename)
	core.register_alias("xdecor:"..original_basename, "xdecor:"..new_basename)
	core.register_alias("xdecor:"..original_basename.."_panel", "xdecor:"..new_basename.."_panel")
	core.register_alias("xdecor:"..original_basename.."_doublepanel", "xdecor:"..new_basename.."_doublepanel")
	core.register_alias("xdecor:"..original_basename.."_micropanel", "xdecor:"..new_basename.."_micropanel")
	core.register_alias("xdecor:"..original_basename.."_halfstair", "xdecor:"..new_basename.."_halfstair")
	core.register_alias("xdecor:"..original_basename.."_thinstair", "xdecor:"..new_basename.."_thinstair")
	core.register_alias("xdecor:"..original_basename.."_cube", "xdecor:"..new_basename.."_cube")
	core.register_alias("xdecor:"..original_basename.."_microslab", "xdecor:"..new_basename.."_microslab")
	core.register_alias("xdecor:"..original_basename.."_nanoslab", "xdecor:"..new_basename.."_nanoslab")
	if not core.get_modpath("moreblocks") then
		core.register_alias("stairs:slab_"..original_basename, "stairs:slab_"..new_basename)
		core.register_alias("stairs:stair_"..original_basename, "stairs:stair_"..new_basename)
		core.register_alias("stairs:stair_outer_"..original_basename, "stairs:stair_outer_"..new_basename)
		core.register_alias("stairs:stair_inner_"..original_basename, "stairs:stair_inner"..new_basename)
	end
	if core.get_modpath("stairsplus") and core.global_exists("stairsplus") and stairsplus.api then
