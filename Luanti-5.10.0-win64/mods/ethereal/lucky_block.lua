...
if core.get_modpath("lucky_block") then-- Don't know how this works V
...
lucky_block:add_blocks({
	...
	{"nod", "default:crystal_spike", 1},
	{"sch", "pinetree", 0, false},
	{"dro", {"default:orange"}, 10},
	...
	{"dro", {"ethereal:dry_dirt_with_fiery_grass"}, 10},
