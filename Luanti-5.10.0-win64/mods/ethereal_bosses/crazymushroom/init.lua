...
mobs:register_mob("crazymushroom:crazymushroom", {
	...
	--stay_near = {"caverealms:stone_with_lichen", 10},
	...
	--glow = 2,
	blood_texture = "mushroom_sapling.png",
...
mobs:spawn({
	...
	nodes = {"caverealms:stone_with_lichen", "caverealms:mushroom"},
	max_light = 7,
	interval = 60,
  chance = 300000,
	max_height = -1500,
...
mobs:register_egg("crazymushroom:crazymushroom", "crazymushroom", "mushroom_block.png", 1)
