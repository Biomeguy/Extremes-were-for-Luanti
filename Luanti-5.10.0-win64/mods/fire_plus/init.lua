...
core.register_globalstep(function(dtime)
	...
	for _, player in pairs(core.get_connected_players()) do
		...
		if fire_plus.burning[name] then
			...
			local nodename_head = core.get_node(vector.add(player:get_pos(),
...
core.register_on_player_hpchange(function(player, _, reason)
...
core.register_on_punchplayer(function(player, hitter, _, toolcaps, _, dmg)
