...
-- bobber
core.register_node("fishing:bobber_box", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
...
--	WHEN RIGHTCLICKING THE BOBBER THE FOLLOWING HAPPENS (CLICK AT THE RIGHT TIME WHILE HOLDING A FISHING POLE)
	...
	core.add_particlespawner({	-- Particles on splash
		amount = 30,
		time = .5,
		minpos = {x=pos.x, y=pos.y-.0625, z=pos.z},
		maxpos = pos,
		minvel = {x=-2,y=-.0625,z=-2},
		maxvel = {x=2,y=3,z=2},
...
core.register_entity("fishing:bobber_fish_entity", FISHING_BOBBER_ENTITY)
