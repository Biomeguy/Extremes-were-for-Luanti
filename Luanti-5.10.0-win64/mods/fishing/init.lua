...
core.log("action","[mod fishing] Loading...")
local path = core.get_modpath("fishing").."/"

fishing_setting = {}
fishing_setting.func = {}
fishing_setting.is_creative_mode = core.settings:get_bool("creative_mode")
fishing_setting.file_settings = core.get_worldpath() .. "/fishing_config.txt"
fishing_setting.file_trophies = core.get_worldpath() .. "/fishing_trophies.txt"
fishing_setting.file_contest = core.get_worldpath() .. "/fishing_contest.txt"
fishing_setting.file_planned = core.get_worldpath() .. "/fishing_planned.txt"
...
if core.get_modpath("intllib") then
  ...
  fishing_setting.func.S = intllib.Getter(core.get_current_modname())
else
...
if core.get_modpath("mobs_fish") or core.get_modpath("mobs_sharks") then
...
core.log("action", "[Mod] "..title.." ["..version.."] ["..mname.."] Loaded...")
