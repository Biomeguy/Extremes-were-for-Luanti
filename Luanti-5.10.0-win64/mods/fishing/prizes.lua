...
--	 mod 				item						wear				message ("You caught "..)		chance
	...
	{"fabric",			"string",					0,					"a String.",					5},
	{"trunks",			"twig_1",					0,					"a Twig.",						5},
	{"mobs_animal",		"rat",						0,					"a Rat.",						5},
	{"default",			"stick",					0,					"a Twig.",						5},
	{"default",			"kelp_green",				0,					"some Green Kelp.",				5},
	...
	{"default",			"sword_blue_diamond",		"random",			"a very old Sword.",			2},
}

fishing_setting.prizes["stuff"] = {}
local nrmin = 1
for i,v in ipairs(stuff) do
	if core.get_modpath(v[1]) and core.registered_items[v[1]..":"..v[2]] then
...
local treasure = {
	...
	{"default",		"spectrum",			0,		"a Light Spectrum."},
	{"default",		"diamond_block",	0,		"a Diamond Block."},
}
