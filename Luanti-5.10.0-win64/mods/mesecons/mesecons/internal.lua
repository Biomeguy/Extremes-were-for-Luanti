...
function mesecon.get_effector(nodename)
	if  core.registered_nodes[nodename]
	and core.registered_nodes[nodename].mesecons
	and core.registered_nodes[nodename].mesecons.effector then
		return core.registered_nodes[nodename].mesecons.effector
	end
end
...
function mesecon.get_receptor(nodename)
	if  core.registered_nodes[nodename]
	and core.registered_nodes[nodename].mesecons
	and core.registered_nodes[nodename].mesecons.receptor then
		return core.registered_nodes[nodename].mesecons.receptor
	end
end
...
function mesecon.get_conductor(nodename)
	if  core.registered_nodes[nodename]
	and core.registered_nodes[nodename].mesecons
	and core.registered_nodes[nodename].mesecons.conductor then
		return core.registered_nodes[nodename].mesecons.conductor
	end
end
