...
mesecon.button_turnoff = function (pos)
	...
	core.swap_node(pos, {name = "mesecons_button:button_off", param2 = node.param2})
	core.sound_play("mesecons_button_pop", {pos = pos})
	local rules = mesecon.rules.buttonlike_get(node)
	mesecon.receptor_off(pos, rules)
end

core.register_node("mesecons_button:button_off", {
	drawtype = "nodebox",
	tiles = {"jeija_wall_button_sides.png",
	...
	on_rightclick = function (pos, node)
		core.swap_node(pos, {name = "mesecons_button:button_on", param2=node.param2})
...
core.register_node("mesecons_button:button_on", {
	drawtype = "nodebox",
	tiles = {"jeija_wall_button_sides.png",
	"jeija_wall_button_sides.png",
	"jeija_wall_button_sides.png",
