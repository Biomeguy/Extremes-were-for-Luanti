...
core.register_node("mesecons_extrawires:crossover_off", {
...
core.register_node("mesecons_extrawires:crossover_01", {
...
core.register_node("mesecons_extrawires:crossover_10", {
	description = "You hacker you!",
	drop = "mesecons_extrawires:crossover_off",
	drawtype = "mesh",
	mesh = "mesecons_extrawires_crossover.b3d",
...
core.register_node("mesecons_extrawires:crossover_on", {
	description = "You hacker you!",
	drop = "mesecons_extrawires:crossover_off",
	drawtype = "mesh",
	mesh = "mesecons_extrawires_crossover.b3d",
...
core.register_craft({
	...
	recipe = {"mesecons_insulated:insulated_off", "mesecons_insulated:insulated_off"}
})

core.register_craft({
	output = "mesecons_insulated:insulated_off 2",
	recipe = {{"mesecons_extrawires:crossover_off"}}
})
