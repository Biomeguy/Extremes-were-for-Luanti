...
local vertical_updatepos = function (pos)
	...
	and core.registered_nodes[node.name].is_vertical_conductor then
		local node_above = core.get_node(vector.add(pos, vertical_rules[1]))
		local node_below = core.get_node(vector.add(pos, vertical_rules[2]))

		local above = core.registered_nodes[node_above.name]
			and core.registered_nodes[node_above.name].is_vertical_conductor
		local below = core.registered_nodes[node_below.name]
			and core.registered_nodes[node_below.name].is_vertical_conductor
