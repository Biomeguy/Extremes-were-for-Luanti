...
-- Fiber
core.register_craftitem("mesecons_insulated:fiber", {
    description = "Fiber",
...
core.register_craft({
	type = "cooking",
	output = "mesecons_insulated:fiber 6",
	recipe = "default:glue",
	cooktime = 4
})

local screwdriver_exists = core.global_exists("screwdriver")
...
core.register_node("mesecons_insulated:insulated_on", {
	drawtype = "nodebox",
	description = "Straight Insulated Mesecon",
	tiles = {"jeija_insulated_wire_sides_on.png", "jeija_insulated_wire_sides_on.png",
...
core.register_node("mesecons_insulated:insulated_off", {
	drawtype = "nodebox",
	description = "Straight Insulated Mesecon",
	tiles = {"jeija_insulated_wire_sides_off.png", "jeija_insulated_wire_sides_off.png",
...
core.register_craft({
	...
	recipe = {
		{"mesecons_insulated:fiber", "mesecons_insulated:fiber", "mesecons_insulated:fiber"},
