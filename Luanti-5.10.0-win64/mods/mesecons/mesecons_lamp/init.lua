...
core.register_node("mesecons_lamp:lamp_on", {
	drawtype = "nodebox",
	...
	mesecons = {effector = {
		action_off = function (pos, node)
			core.swap_node(pos, {name = "mesecons_lamp:lamp_off", param2 = node.param2})
		end,
...
core.register_node("mesecons_lamp:lamp_off", {
	drawtype = "nodebox",
	...
	mesecons = {effector = {
		action_on = function (pos, node)
			core.swap_node(pos, {name = "mesecons_lamp:lamp_on", param2 = node.param2})
		end,
		rules = mesecon.rules.wallmounted_get,
	}},
	on_blast = mesecon.on_blastnode,
