...
local function get_digiline_send(pos, itbl, send_warning)
	if not core.global_exists("digilines") then return end
...
for d = 0, 1 do
	...
	core.register_node(node_name, {
		...
		drawtype = "nodebox",
		tiles = {top, "jeija_microcontroller_bottom.png",
...
core.register_node(BASENAME .. "_burnt", {
	drawtype = "nodebox",
	tiles = {"jeija_luacontroller_burnt_top.png", "jeija_microcontroller_bottom.png",
		"jeija_microcontroller_sides.png", "jeija_microcontroller_sides.png",
		"jeija_microcontroller_sides.png", "jeija_microcontroller_sides.png"},
