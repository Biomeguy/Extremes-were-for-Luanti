...
mobs:register_egg("draconis:jungle_wyvern", S("Jungle Wyvern"), "default_jungle_leaves.png", 1)

-- Jungle Wyvern Egg by ElCeejo

core.register_node("draconis:jungle_wyvern_egg", {
	...
	on_timer = function(pos)
		...
		mob = core.add_entity(pos, "draconis:jungle_wyvern")
