...
-- Swords
core.register_tool("es:sword_emerald", {
...
core.register_tool("es:sword_ruby", {
...
core.register_tool("es:sword_aikerum", {
...
core.register_tool("es:sword_magentium", {
	description = "Extreme Survival Magentium Sword",
	inventory_image = "es_tool_magentiumsword.png",
	tool_capabilities = {
		full_punch_interval = 0.5,
		max_drop_level=4,
		groupcaps={
...
-- Picks
core.register_tool("es:pick_emerald", {
...
core.register_tool("es:pick_ruby", {
...
core.register_tool("es:pick_aikerum", {
...
core.register_tool("es:pick_magentium", {
	description = "Extreme Survival Magentium Pickaxe",
	inventory_image = "es_tool_magentiumpick.png",
	tool_capabilities = {
...
-- Axes
core.register_tool("es:axe_emerald", {
...
core.register_tool("es:axe_ruby", {
...
core.register_tool("es:axe_aikerum", {
...
-- Shovels
core.register_tool("es:shovel_emerald", {
	description = "Extreme Survival Emerald Shovel",
	inventory_image = "es_tool_emeraldshovel.png",
	wield_image = "es_tool_emeraldshovel.png^[transformFX",
	tool_capabilities = {
		full_punch_interval = 1.0,
		max_drop_level=2,
		groupcaps={
...
core.register_tool("es:shovel_ruby", {
	description = "Extreme Survival Ruby Shovel",
	inventory_image = "es_tool_rubyshovel.png",
	wield_image = "es_tool_rubyshovel.png^[transformFX",
	tool_capabilities = {
		full_punch_interval = 0.7,
		max_drop_level=3,
		groupcaps={
...
core.register_tool("es:shovel_aikerum", {
	description = "Extreme Survival Aikerum Shovel",
	inventory_image = "es_tool_aikerumshovel.png",
	wield_image = "es_tool_aikerumshovel.png^[transformFX",
	tool_capabilities = {
		full_punch_interval = 0.25,
		max_drop_level=4,
		groupcaps={
