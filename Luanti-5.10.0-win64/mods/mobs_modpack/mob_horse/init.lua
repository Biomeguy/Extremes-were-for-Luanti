...
mobs:register_mob("mob_horse:horse", {
	type = "animal",
	visual = "mesh",
	visual_size = {x = 1.6, y = 1.6}, -- was {x = 1.20, y = 1.20},
	mesh = "mobs_horse.x",
	...
	walk_chance = 60,
	view_range = 5,
	follow = {"farming:cut_grass", "farming:hay_pile", "farming:wheat", "farming:carrot", "default:apple"},
	passive = true,
	hp_min = 12,
	hp_max = 16,
	armor = 200,
...
mobs:spawn({
	...
	nodes = {"default:dirt_with_grass", "default:dry_dirt"},
	min_light = 14,
	interval = 60,
	chance = 16000,
	min_height = 10,
...
mobs:register_egg("mob_horse:horse", S("Horse"), "fabric_block_brown.png", 1)
...
local apply_shoes = function(name, itemstack, obj, shoes, speed, jump, reverse)
	...
	if ent and ent.name and ent.name == "mob_horse:horse" then
		...
		if ent.shoed then
			core.add_item(mob:get_pos(), ent.shoed)
		end
		...
		core.chat_send_player(name, S("Horse shoes fitted -")
				.. S(" speed: ") .. speed
				.. S(" , jump height: ") .. jump
		...
		core.chat_send_player(name, S("Horse shoes only work on horses!"))
	end
end


-- steel horseshoes
core.register_craftitem(":mobs:horseshoe_steel", {
	...
	on_use = function(itemstack, user, pointd)
		return apply_shoes(user:get_player_name(), itemstack, pointd,
...
-- bronze horseshoes
core.register_craftitem(":mobs:horseshoe_bronze", {
...
-- mese horseshoes
core.register_craftitem(":mobs:horseshoe_mese", {
...
-- diamond horseshoes
core.register_craftitem(":mobs:horseshoe_diamond", {
