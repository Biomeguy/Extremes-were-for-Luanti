...
local items = {
	...
	string = mc2 and "mcl_mobitems:string" or "fabric:string",
	...
	gold_block = mc2 and "mcl_core:goldblock" or "default:gold_block",
	diamond_block = mc2 and "mcl_core:diamondblock" or "default:diamond_block",
	...
	meat_raw = mc2 and "mcl_mobitems:beef" or "group:meat_raw",
	meat_cooked = mc2 and "mcl_mobitems:cooked_beef" or "group:meat",
}
...
core.register_craftitem("mobs:meat", {
	...
	on_use = core.item_eat(8, "bonemeal:bone"),
	groups = {meat = 1, flammable = 2}
})
