...
local function node_is(entity)
	...
	if core.get_item_group(entity.standing_on, "lava") ~= 0 then
		return "lava"
	end

	if core.get_item_group(entity.standing_on, "liquid") ~= 0 then
		return "liquid"
	end

	if core.registered_nodes[entity.standing_on].walkable == true then
		return "walkable"
	end
