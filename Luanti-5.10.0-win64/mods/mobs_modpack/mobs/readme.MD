...
* Added new `line_of_sight` function that uses raycasting if Luanti 5.0 is
...
* Better Luanti 0.4.16 compatibility
...
* Updated to use newer functions, requires Luanti 0.4.16+ to work
