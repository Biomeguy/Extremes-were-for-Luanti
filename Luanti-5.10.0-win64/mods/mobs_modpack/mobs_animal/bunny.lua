...
mobs:register_mob("mobs_animal:bunny", {
	...
	follow = {"farming:carrot", "default:grass_1", "farming:cut_grass", "farming:hay_pile"},
	view_range = 8,
	replace_rate = 10,
	replace_what = {"farming:carrot_S7", "farming:carrot_S8"},
	replace_with = "air",
	...
	on_spawn = function(self)
		...
		if core.find_node_near(pos, 1,
				{"default:snow", "default:snow_block", "default:dirt_with_snow"}) then
...
core.register_craftitem(":mobs:rabbit_raw", {
	...
	on_use = core.item_eat(3, "bonemeal:bone 3"),
	groups = {meat_raw = 1, rabbit_raw = 1, flammable = 2},
})
...
core.register_craftitem(":mobs:rabbit_cooked", {
	...
	on_use = core.item_eat(5, "bonemeal:bone 3"),
	groups = {meat = 1, rabbit = 1, flammable = 2},
})
