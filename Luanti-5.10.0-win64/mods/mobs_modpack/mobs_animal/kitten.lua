...
mobs:register_mob("mobs_animal:kitten", {
	...
	jump = false,
	drops = {
		{name = "fabric:string", chance = 1, min = 0, max = 1},
	},
	water_damage = 0,
	lava_damage = 5,
	fear_height = 3,
...
local hairball_items = {
	...
	"default:clay_lump", "default:paper", "default:savanna_grass_1", "dye:red", "",
	"fabric:string", "mobs:chicken_feather", "default:acacia_bush_sapling", "",
