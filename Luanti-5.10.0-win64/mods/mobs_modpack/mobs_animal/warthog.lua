...
if core.get_mapgen_setting("mg_name") ~= "v6" then
	spawn_on = {"default:dirt_with_savanna_grass"}
	spawn_by = {"group:savanna_grass"}
end

if core.get_modpath("ethereal") then
	spawn_by = {"group:grass", "flowers:mushroom_brown"}
end
...
core.register_craftitem(":mobs:pork_raw", {
	...
	groups = {meat_raw = 1, pork_raw = 1, flammable = 2},
})
...
core.register_craftitem(":mobs:pork_cooked", {
	...
	groups = {meat = 1, pork = 1, flammable = 2},
})
