...
-- load settings
	dofile(core.get_modpath("mobs_crocs").."/SETTINGS.txt")
...
-- no float
	if ENABLE_WALKERS then
		mobs:register_mob("mobs_crocs:crocodile", {
			...
			hp_max = 25,
			armor = 200,
			collisionbox = {-0.85, -0.3, -0.85, 0.85, 1.5, 0.85}, --{-0.75, -0.35, -0.75, 0.75, 0.5, 0.75},
			drawtype = "front",
			visual = "mesh",
			mesh = l_model,
			textures = l_skins,
		...
		mobs:spawn_specific("mobs_crocs:crocodile",
			{"default:dirt_with_grass","default:dirt","group:jungle_grass","default:sand"},
			{"default:water_flowing","default:water_source","default:reed","default:papyrus",
	"default:bulrush_1","default:bulrush_2","default:juncus_1","default:juncus_2"},
...
-- float
	if ENABLE_FLOATERS then
		mobs:register_mob("mobs_crocs:crocodile_float", {
			...
			hp_max = 25,
			armor = 200,
			collisionbox = {-0.638, -0.23, -0.638, 0.638, 1.13, 0.638}, --{-0.57, -0.27, -0.57, 0.57, 0.38, 0.57},
			drawtype = "front",
			visual = "mesh",
			mesh = l_model,
			textures = l_skins,
		...
		mobs:spawn_specific("mobs_crocs:crocodile_float",
			...
			{"default:dirt_with_grass","group:jungle_grass","default:sand","default:dirt","default:reed",
	"default:papyrus","default:bulrush_1","default:bulrush_2","default:juncus_1","default:juncus_2","group:seaweedy"},
...
-- swim
	if ENABLE_SWIMMERS then
		mobs:register_mob("mobs_crocs:crocodile_swim", {
			...
			hp_max = 25,
			armor = 200,
			collisionbox = {-0.425, -0.15, -0.425, 0.425, 0.75, 0.425}, --{-0.38, -0.18, -0.38, 0.38, 0.25, 0.38},
			drawtype = "front",
			visual = "mesh",
			mesh = l_model,
			textures = l_skins,
		...
		mobs:spawn_specific("mobs_crocs:crocodile_swim",
			{"default:water_flowing","default:water_source"},
			{"default:sand","default:dirt","group:seaweedy"},
