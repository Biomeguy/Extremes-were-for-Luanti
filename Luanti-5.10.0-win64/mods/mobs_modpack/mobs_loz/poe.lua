...
mobs:register_mob("mobs_loz:poe", {
	...
	view_range = 10,
	drops = {
		{name = "mobs_loz:soul", chance = 2, min = 1, max = 1},
		{name = "mapgen:red_rupee", chance = 4, min = 1, max = 1},
		{name = "mtools:lantern", chance = 5, min = 1, max = 1},
	},
	animation = {
		speed_normal = 12,
		speed_run = 12,
...
core.register_craftitem("mobs_loz:soul", {
