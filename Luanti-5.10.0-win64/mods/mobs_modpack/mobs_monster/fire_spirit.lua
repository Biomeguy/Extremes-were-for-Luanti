...
mobs:register_mob("mobs_monster:fire_spirit", {
	...
	hp_max = 45,
	armor = 100,
	collisionbox = {-.1, -.4, -.1, .1, .1, .1},
	visual_scale = {x = .5, y = .5, z = .5},
	visual = "sprite",
	textures = {
	...
	immune_to = {
		...
		{"bucket:bucket_fresh_water", 1},
		{"bucket:clay_bucket_water", 1},
		{"bucket:clay_bucket_fresh_water", 1},
		{"bucket:wooden_bucket_water", 1},
		{"bucket:wooden_bucket_fresh_water", 1},
		{"all"}
	},
	...
	do_custom = function(self, dtime)
		...
		if self.state == "attack" and lp ~= true then-- attacking burst
	for i = 1, 5 do
