...
local spider_types = {
	...
	{	nodes = {"default:snow", "default:snow_block", "default:dirt_with_snow"},
		skins = {"mobs_spider_snowy.png"},
		docile = true,
		drops = nil
	},

	{	nodes = {"default:dirt_with_rainforest_litter", "default:jungle_trunk"},
	...
	{	nodes = {"default:mese", "default:stone_with_mese"},
		...
		docile = nil,
		drops = {
			{name = "fabric:string", chance = 1, min = 0, max = 2},
			{name = "default:mese_crystal_fragment", chance = 2, min = 1, max = 4}}
	},

	{	nodes = {"default:dirt_with_blue_moss", "default:crystal_spike"},
		skins = {"mobs_spider_crystal.png"},
		docile = true,
		drops = {
			{name = "fabric:string", chance = 1, min = 0, max = 2},
			{name = "default:crystal_spike", chance = 15, min = 1, max = 2}}
	}
}
...
if not mobs.custom_spawn_monster then
	...
	mobs:spawn({
		...
		nodes = {
			"default:dirt_with_rainforest_litter", "default:snow_block",
			"default:snow", "default:dirt_with_blue_moss", "default:dirt_with_coniferous_litter"
		},
		min_light = 0,
		max_light = 8,
		chance = 7000,
