...
local tree_types = {
	...
	{	nodes = {"ethereal:sakura_leaves", "ethereal:sakura_leaves2"},
		...
		drops = {
			...
			{name = "ethereal:sakura_sapling", chance = 2, min = 0, max = 2}
		}
	},
	...
	{	nodes = {"ethereal:frost_leaves"},
		...
		drops = {
			...
			{name = "ethereal:frost_trunk", chance = 2, min = 1, max = 2},
			{name = "default:crystal_spike", chance = 4, min = 0, max = 2}
		}
	},
...
mobs:register_mob("mobs_monster:tree_monster", {
	...
	drops = {
		...
		{name = "default:jungle_sapling", chance = 3, min = 0, max = 2},
...
mobs:register_egg("mobs_monster:tree_monster", S("Tree Monster"), "default_beech_trunk_top.png", 1)
