...
-- land turtle
	mobs:register_mob("mobs_turtles:turtle", {
		...
		fall_damage = 1,
		animation = l_anims,
		follow = {"farming:carrot", "farming:lettuce_iceberg", "farming:lettuce_romaine"},
	...
	mobs:spawn_specific("mobs_turtles:turtle",
		{"default:dirt_with_grass","group:jungle_grass","default:sand","default:desert_sand"},
		{"default:dirt_with_grass","group:jungle_grass","default:sand","default:desert_sand","default:reed","default:cactus",
	"default:papyrus","default:bulrush_1","default:bulrush_2","default:juncus_1","default:juncus_2"},
...
-- sea turtle
	...
	mobs:spawn_specific("mobs_turtles:seaturtle",
		...
		{"default:water_flowing","default:water_source","group:seaweedy","seawrecks:woodship","seawrecks:uboot"},
