...
local function wood_tile_replace(itemstack, placer, pointd)
	local substack
	...
	local _, success = core.item_place(substack, placer, pointd)
	if success then
		itemstack:take_item()
	end
	return itemstack
...
local nodes = {
	...
	["dirt_compressed"] = {
		description = S("Compressed Dirt (Rammed Earth)"),
		groups = {crumbly=2},
		is_ground_content = false,
		sounds = sound_dirt,
		no_stairs = true,
	...
	["all_faces_beech_trunk"] = {
		description = S("All-faces Beech Trunk"),
		tiles = {"default_beech_trunk_top.png"},
		groups = {trunk = 1, choppy = 2, flammable = 2},
		sounds = sound_wood,
		furnace_burntime = 30,
	},
	["all_faces_jungle_trunk"] = {
		description = S("All-faces Jungle Trunk"),
		tiles = {"default_jungle_trunk_top.png"},
		groups = {trunk = 1, choppy = 2, flammable = 2},
		sounds = sound_wood,
		furnace_burntime = 38,
	},
	["all_faces_pine_trunk"] = {
		description = S("All-faces Pine Trunk"),
		tiles = {"default_pine_trunk_top.png"},
		groups = {trunk = 1, choppy = 3, flammable = 3},
		sounds = sound_wood,
		furnace_burntime = 26,
	},
	["all_faces_acacia_trunk"] = {
		description = S("All-faces Acacia Trunk"),
		tiles = {"default_acacia_trunk_top.png"},
		groups = {trunk = 1, choppy = 2, flammable = 2},
		sounds = sound_wood,
		furnace_burntime = 34,
	},
	["all_faces_aspen_trunk"] = {
		description = S("All-faces Aspen Trunk"),
		tiles = {"default_aspen_trunk_top.png"},
		groups = {trunk = 1, choppy = 3, flammable = 3},
		sounds = sound_wood,
		furnace_burntime = 22,
	},
...
for name, def in pairs(nodes) do
	...
	stairs.register_stair_and_slab(name, "moreblocks:"..name,
		groups, def.tiles,
		def.description.." Stair", def.description.." Slab", def.sounds, true)
	end
end
