...
core.register_node("pipeworks:steel_block_embedded_tube", {
	description = "Airtight steel block embedded tube",
...
core.register_craft({
	output = "pipeworks:steel_block_embedded_tube",
	recipe = {
...
core.register_node("pipeworks:steel_pane_embedded_tube", {
	...
	tiles = {"pipeworks_pane_embedded_tube_sides.png^[transformR90",
		...
		"pipeworks_pane_embedded_tube_ends.png"},
...
core.register_craft({
	output = "pipeworks:steel_pane_embedded_tube",
	recipe = {
		{"", "default:steel_ingot", ""},
		{"", "pipeworks:tube_1", ""},
		{"", "default:steel_ingot", ""}
