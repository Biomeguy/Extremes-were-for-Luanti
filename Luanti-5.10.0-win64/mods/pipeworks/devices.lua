...
function pipeworks.rotate_on_place(itemstack, placer, pointd)

	local pname = placer:get_player_name()
	if not core.is_protected(pointd.under, pname) 
	   and not core.is_protected(pointd.above, pname) then
...
core.register_node("pipeworks:grating", {
	...
	tiles = {"pipeworks_grating_top.png", "pipeworks_grating_sides.png"},
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
