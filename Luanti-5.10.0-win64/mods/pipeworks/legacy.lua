...
if not core.get_modpath("auto_tree_tap") and core.get_modpath("technic") then
	...
	core.register_abm({
		...
		action = function(pos, node, active_object_count, active_object_count_wider)
			...
			core.set_node(pos, {name = "pipeworks:nodebreaker_off", param2 = fdir})
			core.registered_nodes["pipeworks:nodebreaker_off"].on_punch(pos, node)
			inv:set_stack("pick", 1, ItemStack("technic:treetap"))
		end
	})

	core.register_node(":auto_tree_tap:off", {
