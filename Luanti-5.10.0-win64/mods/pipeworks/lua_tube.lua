...
-- Something nice to play is is appending core.env to it.
...
local function set_port_states(pos, ports)
	...
	if name ~= new_name and vports then
		...
		local meta = core.get_meta(pos)
		local ign = core.deserialize(meta:get_string("ignore_offevents")) or {}
...
local function ignore_event(event, meta)
	...
	local ignore_offevents = core.deserialize(meta:get_string("ignore_offevents")) or {}
...
local function get_digiline_send(pos)
	...
	return function(channel, msg)
		...
		local msg_ser = core.serialize(msg)
...
local function load_memory(meta)
	return core.deserialize(meta:get_string("lc_memory")) or {}
end
