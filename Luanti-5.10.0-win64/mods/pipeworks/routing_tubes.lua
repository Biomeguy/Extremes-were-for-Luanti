...
local colriz = "^[colorize:#ff3030:255"

pipeworks.register_tube("pipeworks:broken_tube", {
	description = "Broken Tube (you hacker you)",
	plain = {"pipeworks_broken_tube_plain.png" .. colriz },
	noctr = {"pipeworks_broken_tube_plain.png" .. colriz },
	ends  = {"pipeworks_broken_tube_end.png" .. colriz },
	short = "pipeworks_broken_tube_short.png" .. colriz,
	node_def = {
		...
		on_punch = function(pos, node, puncher, pointd)
			local itemstack = puncher:get_wielded_item()
			local wieldname = itemstack:get_name()
			local pname = puncher:get_player_name()
			print("[Pipeworks] "..pname.." struck a broken tube at "..core.pos_to_string(pos))
...
if pipeworks.enable_priority_tube then
	pipeworks.register_tube("pipeworks:priority_tube", {
			...
			inventory_image = "pipeworks_tube_inv.png" .. colriz,
			plain = {"pipeworks_tube_plain.png" .. colriz },
			noctr = {"pipeworks_tube_noctr.png" .. colriz },
			ends  = {"pipeworks_tube_end.png" .. colriz },
			short = "pipeworks_tube_short.png" .. colriz,
			node_def = {
