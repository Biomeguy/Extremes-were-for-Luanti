if pipeworks.enable_detector_tube then
	local detector_tube_step = 5 * tonumber(core.settings:get("dedicated_server_step"))
	pipeworks.register_tube("pipeworks:detector_tube_on", {
		...
		node_def = {
			tube = {can_go = function(pos, node, velocity, stack)
					 ...
					 core.after(detector_tube_step, core.registered_nodes[name].item_exit, saved_pos)
	...
	core.register_craft({
		...
		recipe = {
			...
			{"mesecons:mesecon", "basic_materials:silicon", "mesecons:mesecon"},
			{"basic_materials:plastic_sheet", "basic_materials:plastic_sheet", "basic_materials:plastic_sheet"}
		}
	})
end
...
if digiline_enabled and pipeworks.enable_digiline_detector_tube then
	...
	core.register_craft({
		...
		recipe = {
			{"basic_materials:plastic_sheet", "basic_materials:plastic_sheet", "basic_materials:plastic_sheet"},
			{"digilines:wire_std_00000000", "basic_materials:silicon", "digilines:wire_std_00000000"},
			{"basic_materials:plastic_sheet", "basic_materials:plastic_sheet", "basic_materials:plastic_sheet"}
		}
	})
end
