...
if pipeworks.enable_mese_sand_tube then
	...
	core.register_craft({
		...
		recipe = {"pipeworks:sand_tube_1", "default:mese_crystal_fragment", "default:mese_crystal_fragment",
...
local function vacuum(pos, radius)
	radius = radius + 0.5
	for _, object in pairs(core.get_objects_inside_radius(pos, math.sqrt(3) * radius)) do
...
core.register_abm({nodenames = {"group:vacuum_tube"},
	interval = 1,
	chance = 1,
	label = "Vacuum tubes",
