...
dirt which can be made into bonemeal, mulch which is crafted using a trunk and
...
- 0.6 - Using newer functions, Luanti 0.4.16 and above needed to run
...
- 1.2 - Added support for Luanti 5.0 cactus seedling, blueberry bush sapling and emergent jungle tree saplings, additional flowers and pine bush sapling.
