...
core.register_node("crops:tomato_seed", {
	...
	on_place = function(itemstack, placer, pointd)
		...
		crops.plant(pointd.above, {name="crops:tomato_plant_1", param2 = 1})
...
for stage = 1, 4 do
core.register_node("crops:tomato_plant_" .. stage , {
...
core.register_node("crops:tomato_plant_5" , {
	description = S("Tomato plant"),
	...
	on_dig = function(pos, node, digger)
		...
		if ttl > 1 then
			core.swap_node(pos, { name = "crops:tomato_plant_4", param2 = 1})
...
core.register_node("crops:tomato_plant_6", {
	description = S("Tomato plant"),
...
core.register_craftitem("crops:tomato", {
...
core.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		n = string.gsub(n, "2", "3")
		n = string.gsub(n, "1", "2")
		core.swap_node(pos, { name = n, param2 = 1 })
	end
})
...
core.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if ttl > 1 then
			core.swap_node(pos, { name = "crops:tomato_plant_5", param2 = 1 })
...
crops.tomato_die = function(pos)
	core.set_node(pos, { name = "crops:tomato_plant_6", param2 = 1 })
end
