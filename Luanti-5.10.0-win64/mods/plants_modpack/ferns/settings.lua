...
-- You can put "--" at the end of a line with "=" in it, or at the beginning of an empty/new line (luanti will ignore what's behind it then).
-- But don't put "--" in front of a line with "=" in it (or else luanti will ignore the setting and you might get an error).
...
abstract_ferns.config.enable_horsetails_on_stones	= true		-- on gravel, mossycobble
