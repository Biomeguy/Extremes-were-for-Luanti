core.register_craft({
	...
	recipe = {
		...
		{'default:diamond_block', 'default:steel_ingot', 'rangedweapons:plastic_sheet'},
...
core.register_craft({
	output = 'rangedweapons:aa12',
	recipe = {
		{'default:silver_ingot', 'default:steel_ingot', 'default:steel_ingot'},
		{'default:diamond_block', 'default:steel_ingot', 'rangedweapons:plastic_sheet'},
		{'default:steel_ingot', 'dye:black', 'rangedweapons:plastic_sheet'}
	}
})

	core.register_craftitem("rangedweapons:aa12", {
	stack_max= 1,
...
core.sound_play("rangedweapons_empty", {object=player})
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:aa12shot")
			if obj then
				...
				obj:set_acceleration({x=dir.x * math.random(-3.5,3.5), y=math.random(-3.5,3.5), z=dir.z * math.random(-3.5,3.5)})
------------------------------------------------------------
			local obj = core.add_entity(pos, "rangedweapons:aa12shot")
				obj:set_velocity({x=dir.x * math.random(18,22), y=dir.y * math.random(18,22), z=dir.z * math.random(18,22)})
				obj:set_acceleration({x=dir.x * math.random(-3.5,3.5), y=math.random(-3.5,3.5), z=dir.z * math.random(-3.5,3.5)})
...
core.register_entity("rangedweapons:aa12shot", rangedweapons_aa12shot )