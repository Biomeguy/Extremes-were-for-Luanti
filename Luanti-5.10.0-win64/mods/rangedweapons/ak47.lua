core.register_craft({
	...
	recipe = {
		{'default:diamond', 'default:steel_ingot', 'default:beech_trunk'},
		{'default:beech_trunk', 'default:mese', 'default:steel_ingot'},
		{'default:steel_ingot', '', 'default:beech_trunk'}
	}
})

	core.register_craftitem("rangedweapons:ak47", {
	stack_max= 1,
...
core.sound_play("rangedweapons_empty", {object=player})
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:ak47shot")
			if obj then
				core.sound_play("rangedweapons_ak", {object=obj})
				obj:set_velocity({x=dir.x * 40, y=dir.y * 40, z=dir.z * 40})
				obj:set_acceleration({x=dir.x * math.random(-2.3,2.3), y=math.random(-2.3,2.3), z=dir.z * math.random(-2.3,2.3)})
...
core.register_entity("rangedweapons:ak47shot", rangedweapons_ak47shot )