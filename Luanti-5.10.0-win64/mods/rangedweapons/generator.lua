...
core.register_node("rangedweapons:generator", {
	...
	tiles = {"rangedweapons_generator_top.png", "rangedweapons_generator_bottom.png", "rangedweapons_generator_side.png"},
	paramtype = "light",
	groups = {cracky = 3, oddly_breakable_by_hand = 3},
	on_timer = function(pos, elapsed)
		core.get_node_timer(pos):start(15)
		pos.y = pos.y+1
	core.add_item(pos, "rangedweapons:power_particle 6")
	end,
