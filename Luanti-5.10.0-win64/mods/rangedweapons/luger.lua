...
core.register_craftitem("rangedweapons:luger_rld", {
	stack_max= 1,
...
core.register_tool("rangedweapons:luger", {
	...
	on_use = function(itemstack, user, pointd)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:lugershot")
			if obj then
...
core.register_entity("rangedweapons:lugershot", rangedweapons_lugershot )
