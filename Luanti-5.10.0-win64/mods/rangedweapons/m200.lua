core.register_craft({
	...
	recipe = {
		{'default:diamond_block', 'default:steel_ingot', 'default:diamond_block'},
		{'default:steel_ingot', 'default:steel_ingot', 'default:steel_ingot'},
		{'default:steel_ingot', 'default:diamond', 'default:steel_ingot'}
	}
})

core.register_craftitem("rangedweapons:m200_uld", {
	stack_max= 1,
...
core.register_craftitem("rangedweapons:m200_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=2.1,y=2.1,z=1.4},
...
core.register_tool("rangedweapons:m200", {
	...
	on_use = function(itemstack, user, pointd)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:m200shot")
			if obj then
				core.sound_play("rangedweapons_rifle_a", {object=obj})
				obj:set_velocity({x=dir.x * 64, y=dir.y * 64, z=dir.z * 64})
...
core.register_entity("rangedweapons:m200shot", rangedweapons_m200shot )
