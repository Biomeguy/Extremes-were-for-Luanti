core.register_craft({
	...
	recipe = {
		...
		{'default:steel_ingot', 'default:steel_block', 'default:steel_block'},
		{'dye:black', 'default:diamond', 'default:steel_ingot'}
	}
})

	core.register_craftitem("rangedweapons:m60", {
	stack_max= 1,
...
core.sound_play("rangedweapons_empty", {object=player})
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:m60shot")
			if obj then
...
core.register_entity("rangedweapons:m60shot", rangedweapons_m60shot )