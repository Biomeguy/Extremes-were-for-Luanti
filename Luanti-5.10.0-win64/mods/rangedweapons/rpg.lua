core.register_craft({
	...
	recipe = {
		...
		{'default:steel_block', 'default:beech_trunk', 'default:diamond_block'},
		{'default:diamond', 'default:beech_trunk', ''}
	}
})

core.register_craftitem("rangedweapons:rpg_uld", {
	stack_max= 1,
...
core.register_craftitem("rangedweapons:rpg_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=2.5,y=2.5,z=3.75},
...
core.register_tool("rangedweapons:rpg", {
	...
	on_use = function(itemstack, user, pointd)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:rocket")
			if obj then
