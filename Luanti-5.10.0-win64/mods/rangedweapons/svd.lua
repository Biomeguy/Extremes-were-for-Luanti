core.register_craft({
	...
	recipe = {
		{'default:steel_ingot', 'default:diamond_block', 'default:steel_ingot'},
		{'default:steel_ingot', 'default:steel_ingot', 'default:steel_ingot'},
		{'default:beech_trunk', 'default:diamond', 'default:beech_trunk'}
	}
})

core.register_craftitem("rangedweapons:svd_uld", {
	stack_max= 1,
...
core.register_craftitem("rangedweapons:svd_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
...
core.register_tool("rangedweapons:svd", {
	...
	on_use = function(itemstack, user, pointd)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:svdshot")
			if obj then
...
core.register_entity("rangedweapons:svdshot", rangedweapons_svdshot )
