core.register_craft({
	...
	core.register_craftitem("rangedweapons:tmp", {
	stack_max= 1,
...
core.sound_play("rangedweapons_empty", {object=player})
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:tmpshot")
			if obj then
...
core.register_entity("rangedweapons:tmpshot", rangedweapons_tmpshot )