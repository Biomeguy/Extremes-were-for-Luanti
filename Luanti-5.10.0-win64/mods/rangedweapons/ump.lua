core.register_craft({
	...
	core.register_craftitem("rangedweapons:ump", {
	stack_max= 1,
...
core.sound_play("rangedweapons_empty", {object=player})
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:umpshot")
			if obj then
			...
			pos.y = pos.y + 0
			local obj = core.add_entity(pos, "rangedweapons:empty_shell_white")
...
core.register_entity("rangedweapons:umpshot", rangedweapons_umpshot )