core.register_craft({
	...
	core.register_craftitem("rangedweapons:uzi", {
	stack_max= 1,
...
core.sound_play("rangedweapons_empty", {object=player})
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = core.add_entity(pos, "rangedweapons:uzishot")
			if obj then
				core.sound_play("rangedweapons_machine_pistol", {object=obj})
				obj:set_velocity({x=dir.x * 25, y=dir.y * 25, z=dir.z * 25})
				obj:set_acceleration({x=dir.x * math.random(-3.1,3.1), y=math.random(-3.1,3.1), z=dir.z * math.random(-3.1,3.1)})
...
core.register_entity("rangedweapons:uzishot", rangedweapons_uzishot )