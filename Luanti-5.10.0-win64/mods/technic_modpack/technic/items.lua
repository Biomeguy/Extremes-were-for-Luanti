...
core.register_tool("technic:blue_energy_crystal", {
	description = S("Blue Energy Crystal"),
	inventory_image = core.inventorycube("technic_diamond_block_blue.png",
...
core.register_tool("technic:green_energy_crystal", {
	description = S("Green Energy Crystal"),
	inventory_image = core.inventorycube("technic_diamond_block_green.png",
...
core.register_tool("technic:red_energy_crystal", {
	description = S("Red Energy Crystal"),
	inventory_image = core.inventorycube("technic_diamond_block_red.png",
