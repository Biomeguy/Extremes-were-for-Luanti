...
for i = 0, 64 do
	core.register_alias("technic:hv_cable"..i, "technic:hv_cable")
	core.register_alias("technic:mv_cable"..i, "technic:mv_cable")
	core.register_alias("technic:lv_cable"..i, "technic:lv_cable")
end
