...
core.register_node("technic:forcefield_emitter_off", {
	...
	tiles = {"technic_forcefield_emitter_off.png", "technic_machine_bottom.png"..cable_entry, "technic_forcefield_emitter_off.png"},
...
core.register_node("technic:forcefield_emitter_on", {
	description = S("%s Forcefield Emitter"):format("HV"),
	tiles = {"technic_forcefield_emitter_on.png", "technic_machine_bottom.png"..cable_entry, "technic_forcefield_emitter_on.png"},
	groups = {cracky = 1, technic_machine = 1, technic_hv = 1, not_in_creative_inventory=1},
