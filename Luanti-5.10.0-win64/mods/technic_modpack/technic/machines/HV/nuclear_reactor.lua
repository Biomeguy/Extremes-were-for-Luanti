...
local digiline_remote_path = core.get_modpath("digiline_remote")
...
local function reactor_structure_badness(pos)
	...
	local c_steel = core.get_content_id("default:stainless_steel_block")
...
local nuclear_reactor_receive_fields = function(pos, formname, fields, sender)
	...
	if core.is_protected(pos, pname) then
		core.chat_send_player(pname, "You are not allowed to edit this!")
	...
	if fields.start then
		...
		if b then
			core.chat_send_player(pname, "Start successful")
		else
			core.chat_send_player(pname, "Error")
		end
	end
...
core.register_node("technic:hv_nuclear_reactor_core", {
	...
	tiles = {"technic_hv_nuclear_reactor_core.png", "technic_hv_nuclear_reactor_core.png"..cable_entry},
	drawtype = "mesh",
	...
	on_construct = function(pos)
		...
		if digiline_remote_path then
			meta:set_string("remote_channel",
					"nucelear_reactor"..core.pos_to_string(pos))
		end
		local inv = meta:get_inventory()
		inv:set_size("src", 6)
	end,
