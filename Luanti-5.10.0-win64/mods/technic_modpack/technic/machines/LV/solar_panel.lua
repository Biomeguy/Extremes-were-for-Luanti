...
core.register_craft({
	...
	recipe = {
		...
		{'basic_materials:silver_wire', 'technic:lv_cable', 'default:glue'}
	},
...
local run = function(pos, node)
	...
	local light = core.get_node_light(pos1)
...
core.register_node("technic:solar_panel", {
	...
	groups = {snappy=2, choppy=2, oddly_breakable_by_hand=2, technic_machine=1, technic_lv=1},
