...
core.register_craft({
	...
	recipe = {
		{'default:marble', 'default:diamond', 'default:marble'},
		{'group:wood', 'technic:machine_casing', 'group:wood'},
		{'default:marble', 'technic:lv_cable', 'default:marble'},
	}
})
...
local function check_node_around_mill(pos)
	...
	if node.name == "default:water_flowing"
	  or node.name == "default:fresh_water_flowing" then
...
core.register_node("technic:water_mill", {
	...
	tiles = {"technic_water_mill_top.png", "technic_machine_bottom.png"..cable_entry,
