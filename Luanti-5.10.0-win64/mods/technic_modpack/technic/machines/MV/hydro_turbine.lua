...
core.register_craft({
	...
	recipe = {
		{'default:stainless_steel_ingot', 'technic:water_mill', 'default:stainless_steel_ingot'},
...
local function get_water_flow(pos)
	...
	if core.get_item_group(node.name, "water") == 3 and string.find(node.name, "flowing") then
...
core.register_node("technic:hydro_turbine", {
	...
	tiles = {"technic_hydro_turbine_top.png", "technic_machine_bottom.png"..cable_entry, "technic_hydro_turbine_side.png"},
	paramtype2 = "facedir",
...
core.register_node("technic:hydro_turbine_active", {
	description = S("Hydro %s Generator"):format("MV"),
	tiles = {"technic_hydro_turbine_top_active.png", "technic_machine_bottom.png", "technic_hydro_turbine_side.png"},
	paramtype2 = "facedir",
	groups = {snappy=2, choppy=2, oddly_breakable_by_hand=2,
