...
core.register_craft({
	output = 'technic:power_radiator',
	recipe = {
		{'default:stainless_steel_ingot', 'technic:mv_transformer', 'default:stainless_steel_ingot'},
...
local toggle_on_off_inductive_appliances = function(pos, node, puncher)
	...
	for _, pos1 in pairs(positions) do
		local meta1 = core.get_meta(pos1)
		if meta1:get_string("has_supply") == pos.x..pos.y..pos.z then
			core.punch_node(pos1)
		end
	end
end

core.register_node("technic:power_radiator", {
