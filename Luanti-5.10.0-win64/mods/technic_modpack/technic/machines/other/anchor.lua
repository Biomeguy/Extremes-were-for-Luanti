...
local function set_display(pos, meta)
	...
	meta:set_string("formspec",
		...
		"label[1,0;"..core.formspec_escape(desc).."]"..
		"label[0,1;"..core.formspec_escape(S("Owner:").." "..meta:get_string("owner")).."]"..
		(meta:get_int("locked") == 0 and
			"button[3,1;2,1;lock;"..core.formspec_escape(S("Unlocked")).."]" or
			"button[3,1;2,1;unlock;"..core.formspec_escape(S("Locked")).."]")..
		"field[0.25,2.3;1,1;radius;"..core.formspec_escape(S("Radius:"))..";"..meta:get_int("radius").."]"..
		(meta:get_int("enabled") == 0 and
			"button[3,2;2,1;enable;"..core.formspec_escape(S("Disabled")).."]" or
			"button[3,2;2,1;disable;"..core.formspec_escape(S("Enabled")).."]")..
		"label[0,3;"..core.formspec_escape(S("Keeping %d/%d map blocks loaded"):format(#currently_forceloaded_positions(meta), #compute_forceload_positions(pos, meta))).."]")
end
