...
core.register_node("technic:power_monitor",{
	...
	tiles = {"technic_power_monitor_sides.png", "technic_power_monitor_sides.png"..cable_entry,
		"technic_power_monitor_sides.png", "technic_power_monitor_sides.png",
		"technic_power_monitor_sides.png"..cable_entry, "technic_power_monitor_front.png"},
	paramtype2 = "facedir",
...
core.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		local meta = core.get_meta(pos)
		local network_hash = technic.cables[core.hash_node_position(pos)]
		local network = network_hash and core.get_position_from_hash(network_hash)
		...
		if timeout > 0 and sw_pos and core.get_node(sw_pos).name == "technic:switching_station" then
			local sw_meta = core.get_meta(sw_pos)
