...
local recipes = {
	...
	{"technic:stainless_steel_dust 4",	"technic:wrought_iron_dust 3",	"technic:chromium_dust",	"technic:coal_dust"},
	{"technic:brass_dust 3",			"technic:copper_dust 2",		"technic:zinc_dust"},
	{"technic:chernobylite_dust",		"default:sand",					"technic:uranium3_dust"},
	{"default:dirt 2",					"default:sand",					"default:compost"},
	{"default:clay_dirt 2",			"default:sand",					"default:compost",		"default:clay_lump 2"},
}
...
if core.get_modpath("farming") then
	table.insert(recipes, {"farming:wheat 4", "farming:seed_wheat 32", "farming:straw_pile 4"})
end
