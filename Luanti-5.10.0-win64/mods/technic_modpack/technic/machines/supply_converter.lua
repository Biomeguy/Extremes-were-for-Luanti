...
local run = function(pos, node, run_stage)
	...
	if enabled == "" then
		...
		core.registered_nodes["technic:supply_converter"].on_construct(pos)
		enabled = true
	else
		enabled = enabled == "1"
	end
...
core.register_node("technic:supply_converter", {
	...
	tiles = {"technic_supply_converter_tb.png"..cable_entry, "technic_supply_converter_tb.png"..cable_entry,
		"technic_supply_converter_side.png", "technic_supply_converter_side.png",
		"technic_supply_converter_side.png", "technic_supply_converter_side.png"},
	groups = {snappy=2, choppy=2, oddly_breakable_by_hand=2, technic_machine=1, technic_all_tiers=1},
	...
	on_construct = function(pos)
		...
		if digilines_path then
			meta:set_string("channel", "supply_converter"..core.pos_to_string(pos))
		end
