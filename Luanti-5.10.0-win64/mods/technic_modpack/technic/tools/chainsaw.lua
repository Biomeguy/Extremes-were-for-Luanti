...
local timber_nodenames = {
	["default:acacia_trunk"] = true,
	["default:aspen_trunk"] = true,
	["default:jungle_trunk"] = true,
	["default:reed"] = true,
	["default:cactus"] = true,
	["default:beech_trunk"] = true,
	["default:apple_trunk"] = true,
	["default:apple"] = true,
	["default:pine_trunk"] = true,
}

if chainsaw_leaves then
	timber_nodenames["default:acacia_leaves"] = true
	timber_nodenames["default:aspen_leaves"] = true
	timber_nodenames["default:beech_leaves"] = true
	timber_nodenames["default:jungle_leaves"] = true
	timber_nodenames["default:pine_needles"] = true
end

-- rubber tree
if core.get_modpath("rubber_tree") then
	timber_nodenames["rubber_tree:trunk_empty"] = true
	timber_nodenames["rubber_tree:trunk"] = true
	if chainsaw_leaves then
		timber_nodenames["rubber_tree:leaves"] = true
	end
end
...
if core.get_modpath("growing_cactus") then
...
-- Support nature
if core.get_modpath("nature") then
	if chainsaw_leaves then
...
if core.get_modpath("vines") then
	if chainsaw_leaves then
...
local function chainsaw_dig(pos, current_charge)
	...
	core.sound_play("chainsaw", {pos = pos, gain = 1.0,
...
core.register_tool("technic:chainsaw", {
	...
	on_use = function(itemstack, user, pointd)
		...
		if core.is_protected(pointd.under, name) then
			core.record_protection_violation(pointd.under, name)
			return
		end

		-- Send current charge to digging function so that the
		-- chainsaw will stop after digging a number of nodes
		meta.charge = chainsaw_dig(pointd.under, meta.charge)
...
core.register_craft({
	...
	recipe = {
		{"default:stainless_steel_ingot", trigger, "technic:battery"},
