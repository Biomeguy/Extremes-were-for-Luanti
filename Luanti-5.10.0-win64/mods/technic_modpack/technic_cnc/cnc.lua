...
if technic_cnc.use_technic then
	...
	core.register_craft({
		...
		recipe = {
			...
			{'basic_materials:ic', 'default:steel_block', 'basic_materials:motor'},
	...
	can_dig = function(pos, player)
		if player and core.is_protected(pos, player:get_player_name()) then return false end
...
local run = function(pos, node)
	...
	if inv:is_empty("src") or
	   (not core.registered_nodes[result]) or
...
core.register_node(":technic:cnc", {
	description = desc_tr,
...
if technic_cnc.use_technic then
	...
	core.register_node(":technic:cnc_active", {
		description = desc_tr,
	...
	core.register_alias("technic:cnc_active", "technic:cnc")
end
