local modpath = core.get_modpath("technic_cnc")

technic_cnc = {}

technic_cnc.technic_modpath = core.get_modpath("technic")

technic_cnc.use_technic = technic_cnc.technic_modpath and core.settings:get_bool("technic_cnc_use_technic") ~= false
