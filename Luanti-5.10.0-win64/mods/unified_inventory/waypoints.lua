...
ui.register_page("waypoints", {
	get_formspec = function(player)
		...
		local temp = waypoints_temp[pname][sel] or {}
...
core.register_on_player_receive_fields(function(player, formname, fields)
	...
	local waypoints = get_waypoint_data(player)
	local temp = waypoints_temp[pname]
	for i = 1, COUNT do
...
table.insert(core.registered_on_joinplayers, 1, function(player)
	...
	waypoints_temp[pname] = {}
	for i = 1, COUNT do
		update_hud(player, waypoints, waypoints_temp[pname], i)
	end
end)
