...
paramat (CC BY-SA 3.0):
  ...
  default_fresh_water.png
  default_fresh_water_source_animated.png
  default_fresh_water_flowing_animated.png
  default_savanna_grass.png
  default_savanna_grass_side.png
  default_savanna_grass_*.png
