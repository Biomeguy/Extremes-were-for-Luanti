...
-- Check for engine features required by Isolus
-- This provides clear error behaviour when Isolus is newer than the installed engine
...
if ItemStack("").add_wear_by_uses == nil then
	error("\nIsolus is incompatible with your engine version (which is too old). "..
		"You should download a version of Luanti that is 5.9.1 or later.\n")
end
