...
-- Handles rotation
screwdriver.handler = function(itemstack, user, pointd, mode, uses)
...
core.register_tool("screwdriver:screwdriver", {
	...
	on_use = function(itemstack, user, pointd)
		screwdriver.handler(itemstack, user, pointd, screwdriver.ROTATE_FACE, 200)
		return itemstack
	end,
	on_place = function(itemstack, user, pointd)
		screwdriver.handler(itemstack, user, pointd, screwdriver.ROTATE_AXIS, 200)
		return itemstack
	end,
})
