...
local function entity_physics(pos, radius, drops)
	...
	if luaobj.name == "nssm:morvalar0" or luaobj.name == "nssm:morvalar5" then-- Tweak
		do_damage = false
		do_knockback = false
	else
...
core.register_node("tnt:gunpowder", {
	...
	walkable = false,
	tiles = {
		"tnt_gunpowder_straight.png", "tnt_gunpowder_curved.png",
		"tnt_gunpowder_t_junction.png", "tnt_gunpowder_crossing.png"
	},
	...
	on_punch = function(pos, node, puncher)
		...
		if itemname == "default:torch" or itemname == "gloop:kalite_torch" or itemname == "xtraores:antracite_torch" then
...
core.register_craft({	--	gravel = potassium nitrate
	output = "tnt:gunpowder 15",
	recipe = {
		{"group:coal", "default:sulfur", "group:coal"},
		{"default:gravel", "group:coal", "default:gravel"},
...
function tnt.register_tnt(def)
	...
	core.register_node(":" .. name .. "_burning", {
		...
		drop = "",
		sounds = default.node_sound_wood_defaults(),
		groups = {falling_node = 1, falling_node_damage = 4, not_in_creative_inventory = 1},
		on_timer = function(pos, elapsed)
			tnt.boom(pos, def)
		end,
		-- unaffected by explosions
