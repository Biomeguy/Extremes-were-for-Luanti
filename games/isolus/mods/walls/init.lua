...
walls.register = function(wall_name, wall_desc, wall_texture_table, wall_mat, wall_mat_groups, wall_sounds)
...
walls.register("walls:cobble", S("Cobblestone Wall"), {"default_cobble.png"},
		"default:cobble", {cracky = 3, stone = 1}, default.node_sound_stone_defaults())

walls.register("walls:mossycobble", S("Mossy Cobblestone Wall"), {"default_mossycobble.png"},
		"default:mossycobble", {cracky = 3, stone = 1}, default.node_sound_stone_defaults())

walls.register("walls:desertcobble", S("Desert Cobblestone Wall"), {"default_desert_cobble.png"},
		"default:desert_cobble", {cracky = 3, stone = 1}, default.node_sound_stone_defaults())

walls.register("walls:diamite", S("Diamite Wall"), {"default_diamite.png"},
		"default:diamite", {cracky = 1, level = 2}, default.node_sound_stone_defaults())
